...
//    private final MutableLiveData<RawDetailsResponse> detailsResponse = new MutableLiveData<>();
//
//    // Mock objects
...
//        doReturn(detailsResponse).when(detailsRepository).getDetailsRestaurant(placeId);
//
...
//        // Given
//        detailsResponse.setValue(new RawDetailsResponse());
