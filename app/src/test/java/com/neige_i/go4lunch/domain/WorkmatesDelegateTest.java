...
public class WorkmatesDelegateTest {
    ...
    @Test
    public void moveToFirstPosition_when_conditionIsMet() {
        // GIVEN
    ...
    @Test
    public void doNotMoveInt_when_conditionIsNeverMet() {
        // GIVEN
        final List<Integer> integerList = new ArrayList<>(Ints.asList(1, 2, 3, 4, 5));
    ...
    @Test
    public void returnFalse_when_dateIsNull() {
        // WHEN
    ...
    @Test
    public void returnTrue_when_dateIsToday() {
        // GIVEN
        // WHEN
    ...
    @Test
    public void returnFalse_when_dateIsNotToday() {
        // WHEN
